    ...
    <div class="-mx-4 flex flex-wrap lg:justify-between">
      <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
        <div class="mb-12 max-w-[570px] lg:mb-0">
          ...
          At Carry With Care, we are committed to providing our customers with fast and reliable delivery services, as well as exceptional customer support. If you have any questions or concerns about our services, we are here to help.
          </p>
          ...
          <div class="mb-8 flex w-full max-w-[370px]">
            ...
            <div class="w-full">
              ...
              <p class=" ">carrywithcarectg@</p>
            </div>
          </div>
         
          <p class="text-body-color mb-9 text-base leading-relaxed text-gray-600">
          Our customer support team is available [ Sat-Fri 09:00AM-10:00PM ] to assist you with any questions or concerns you may have. Whether you need help placing an order, tracking your delivery, or resolving an issue, we are here to help.
          </p>
        </div>
      </div>
