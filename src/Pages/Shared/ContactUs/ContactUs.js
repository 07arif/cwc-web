...
const ContactUs = () => {
  return (
    <div>
      ...
      <section class="relative z-10 overflow-hidden py-10 px-3 container max-w-xl  mx-auto space-y-24 lg:px-8 lg:max-w-7xl text-start lg:text-center">
          ...
          <div class="-mx-4 flex flex-wrap lg:justify-between">
            <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div class="mb-12 max-w-[570px] lg:mb-0">
                ...
                <h2
                  class="text-dark mb-6 text-[32px] font-logo uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]"
                >
                  GET IN TOUCH WITH US
                </h2>
                <p class="text-body-color mb-9 text-base leading-relaxed text-gray-600">
                  CARRY with CARE 2.0 এর প্রিমিয়াম ডেলিভারী সাপোর্টের মাধ্যমে আপনি খুব দ্রুত এবং সঠিক সময়ে ডেলিভারীর সুবিধা পাচ্ছেন। আপনি যে সময়ে বলবেন, সে সময়েই আমাদের রাইডাররা আপনার কাছ থেকে পণ্য পিকাপ করে তখনি আপনার কাস্টমারের কাছে দিয়ে আসবে। ৩০-৪৫ মিনিট সময়ের মাঝেই।</p>
                <div class="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div class="w-full">
                    ...
                    <p class="text-body-color text-base">
                      Shop No. 213, 1st Floor, K Plaza, Mirzarpul, Muradpur, Chattogram.
                    </p>
                  </div>
                </div>
                <div class="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div class="w-full">
                    ...
                    <p class="text-body-color text-base">(+88) 01883 277339</p>
                  </div>
                </div>
                <div class="mb-8 flex w-full max-w-[370px]">
                  <div
                  ...
                  <div class="w-full">
                    ...
                    <p class=" ">carrywithcarectg@gmail.com</p>
                  </div>
                </div>

                <p class="text-body-color mb-9 text-base leading-relaxed text-gray-600">
                  CARRY with CARE 2.0 প্রথমদিন থেকেই কাস্টমার এক্সপেরিয়েন্সের দিকে সর্বোচ্চ খেয়াল দিয়ে এসেছে। এরই পরিপ্রেক্ষিতে আপনারা আমাদের কাছ থেকে পাচ্ছেন দিনে ১৮ ঘন্টা কাস্টমার সাপোর্ট। ডেলিভারী সংক্রান্ত যে কোনো সমস্যার জন্যে আমাদেরকে সরাসরি কল দিতে পারেন। পেইজে রেসপন্স পাবেন সকাল ১০ টা থেকে রাত ৪টা পর্যন্ত।</p>
              </div>
            </div>
            <div class="w-full px-3 lg:px-4 lg:w-1/2 xl:w-5/12">
              <div class="relative rounded-lg bg-white p-2 lg:p-8 shadow-lg sm:p-12">
                <form>
                  <div class="mb-6">
                    <input
                      type="text"
                  ...
                  <div>
                    <button
                      type="submit"
                      class="bg-gradient-to-r from-cyan-400 to-purple-500 border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
